  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1610030469983-98e550d6193c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&h=1080")',
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="hero-subtitle text-lg md:text-xl mb-8 opacity-0 transform translate-y-8 max-w-2xl mx-auto">
            Discover timeless elegance with our curated selection of traditional
          ...
          <div className="hero-buttons space-x-4 opacity-0 transform translate-y-8">
            ...
            <Link to="/products?category=wedding-sarees">
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-charcoal px-8 py-3 font-semibold transition-all"
              >
                Wedding Collection
              </Button>
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Explore our diverse range of traditional and modern sarees
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="text-center py-12">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {[...Array(4)].map((_, i) => (
                  <div
                    key={i}
                    className="bg-gray-200 rounded-xl h-80 shimmer"
                  />
                ))}
              </div>
            </div>

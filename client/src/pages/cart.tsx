...
import { ShoppingBag, Minus, Plus, Trash2, ArrowRight, ShieldCheck, Truck } from 'lucide-react';
  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h1 className="text-3xl font-bold text-charcoal mb-2">Shopping Cart</h1>
                          ...
                          <div className="text-right">
                            ...
                            {item.product.originalPrice && (
                              <p className="text-sm text-gray-500 line-through">
                                ₹{(parseFloat(item.product.originalPrice) * item.quantity).toLocaleString()}
                              </p>
                            )}
                          </div>
